...
<body>
    <div class="container">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(200px,1fr)); gap:1rem; margin-bottom:1rem;">
            <div class="card">
                <h4>Total Items</h4>
                <p style="font-size:1.6rem; font-weight:700"><?= $totalItems ?? 0 ?></p>
            </div>
            <div class="card">
                <h4>Recent Activities</h4>
                <p style="font-size:1.6rem; font-weight:700"><?= !empty($recentActivity) ? count($recentActivity) : 0 ?></p>
            </div>
            <div class="card">
                <h4>Role</h4>
                <p style="font-size:1.2rem; font-weight:600">Supplier</p>
            </div>
        </div>
